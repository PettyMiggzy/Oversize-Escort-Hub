...
.nav{background:rgba(6,8,10,.98);border-bottom:1px solid var(--l1);height:56px;display:flex;flex-direction:row;align-items:center;padding:0 24px;gap:20px;position:sticky;top:0;z-index:100;backdrop-filter:blur(8px)}
    ...
    <footer>
      <div className="footer-grid">
        ...
        <div className="footer-col">
          <h4>Platform</h4>
          <><a href="/flat-rate">Flat Rate Board</a><a href="/bid-board">5-Min Bid Board</a><a href="/open-loads">Open Bid Board</a><a href="/post-load">Post a Load</a><a href="/find-escorts">Find Escorts</a></>
        </div>
        <div className="footer-col">
          <h4>Membership</h4>
