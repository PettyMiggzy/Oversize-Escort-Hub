    ...
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ccc", fontFamily: "sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "60px 24px", lineHeight: 1.8 }}>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <section style={{ marginBottom: 32 }}>
            <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>22. MC/DOT Number Collection for Fraud Prevention</h2>
          ...
          </section> <section style={{marginBottom:32}}><h2 style={{color:"#fff",fontSize:18,marginBottom:12}}>23. Escort Availability Board</h2><p style={{color:"#ccc"}}>The Escort Availability Board allows licensed P/EVO escorts to post their availability window, location, and certifications. Carriers may contact escorts directly. OEH does not guarantee job placement or successful matching through the board.</p></section><section style={{marginBottom:32}}><h2 style={{color:"#fff",fontSize:18,marginBottom:12}}>24. SMS Load Posting</h2><p style={{color:"#ccc"}}>Pro subscribers and carriers may post loads via SMS. Standard carrier messaging rates may apply. OEH is not responsible for delivery failures. SMS load posting requires opt-in and compliance with all applicable 10DLC messaging regulations.</p></section><section style={{marginBottom:32}}><h2 style={{color:"#fff",fontSize:18,marginBottom:12}}>25. BGC Badge and Refund Policy</h2><p style={{color:"#ccc"}}>The BGC Badge is a one-time $9.99 fee. This fee is non-refundable once the background check process has been initiated. OEH does not guarantee employment or matching based on BGC status.</p></section><section style={{marginBottom:32}}><h2 style={{color:"#fff",fontSize:18,marginBottom:12}}>26. Canadian Province Support</h2><p style={{color:"#ccc"}}>OEH supports load posting and escort operations across Canadian provinces. Users are solely responsible for complying with all applicable provincial permits, regulations, and cross-border transportation laws.</p></section><section style={{marginBottom:32}}><h2 style={{color:"#fff",fontSize:18,marginBottom:12}}>27. Curfew and State Route Disclaimer</h2><p style={{color:"#ccc"}}>Curfew hours, travel time restrictions, and permit information displayed on OEH are for reference only and may not be current. Users must verify all requirements with the appropriate state or provincial authority before each trip.</p></section>
          
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>28. Evergreen Safety Council Partnership</h2>
          <p style={{ color: "#ccc" }}>Oversize Escort Hub is an official member of the Evergreen Safety Council (membership INV14545). Through this partnership, OEH Member, Pro, and Fleet subscribers receive a 5% discount on all bookable Evergreen Safety Council courses — including P/EVO, WITPAC, Flagger, TCS, and related certifications. Use promo code <strong style={{ color: '#f0a500' }}>OSEH2026</strong> at checkout on the Evergreen Safety Council site. The Evergreen Safety Council is an independent third party; OEH does not operate, accredit, or guarantee their courses. Enrollment, course content, scheduling, and certification issuance are governed solely by the Evergreen Safety Council's own terms.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>29. OSEH2026 Promo Code Terms</h2>
          <p style={{ color: "#ccc" }}>The <strong style={{ color: '#f0a500' }}>OSEH2026</strong> promo code is valid through April 30, 2027, and provides a 5% discount on Evergreen Safety Council course enrollment at the time of checkout on the Evergreen Safety Council's platform. The code is available only to active OEH Member, Pro, and Fleet subscribers in good standing. The discount is non-transferable, cannot be combined with other offers, applies only to courses Evergreen Safety Council designates as bookable, and may be suspended, modified, or withdrawn by OEH or by the Evergreen Safety Council at any time without notice. OEH is not responsible for promo code honoring on the third-party Evergreen Safety Council site.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>30. Marketplace Liability Waiver</h2>
          <p style={{ color: "#ccc" }}>Oversize Escort Hub is a neutral marketplace that facilitates discovery and communication between independent carriers, brokers, escorts (P/EVO, WITPAC, Flagger, TCS), and related transportation professionals. <strong>OEH is not a party to any contract, engagement, booking, agreement, or transaction between users.</strong> OEH does not provide escort, pilot car, flagging, or motor carrier services and makes no warranty regarding the accuracy of user-submitted credentials, the performance of any service, the suitability of any match, the outcome of any trip, or the resolution of any dispute. Users engage one another at their own risk and are solely responsible for independently verifying licensure, insurance, permits, and operating authority before performing or accepting any work. To the fullest extent permitted by law, OEH disclaims all liability arising from or relating to agreements formed between users on the Platform.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>31. Broker Self-Certification</h2>
          <p style={{ color: "#ccc" }}>Freight brokers and broker-carriers who use the Platform to post loads represent and warrant that they hold a valid MC/DOT authority with appropriate broker authority, are in good standing with the FMCSA, maintain the surety bond (BMC-84) or trust fund (BMC-85) required by 49 CFR § 387.307, and are not subject to any suspension, revocation, or out-of-service order. By posting a load, the broker self-certifies compliance with all applicable federal and state brokerage laws and agrees to honor posted rates, provide accurate load information, and pay carriers and escorts in accordance with industry-standard terms. OEH may suspend or remove broker accounts that fail to maintain valid authority or that receive repeated verified complaints regarding non-payment or misrepresentation.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>32. Fleet Manager Multi-Escort Coordination</h2>
          <p style={{ color: "#ccc" }}>Fleet Manager tools (available on the Pro and Fleet tiers) allow a single operator to coordinate load assignments, availability, and communications on behalf of multiple escort operators. By using Fleet Manager tools, the Fleet Manager represents that they have obtained prior written consent from each escort whose information is entered, accept, or relay on the Platform. Each escort remains an independent operator responsible for their own licensure, insurance, equipment, and acceptance of any specific job. OEH does not act as an employer, dispatcher, or agent of any escort, and fleet coordination through the Platform does not create an employment, agency, or partnership relationship between OEH, the Fleet Manager, and the escorts they coordinate. Fleet search activity is rate-limited and logged for abuse prevention.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>33. SMS Messaging & 10DLC Compliance</h2>
          <p style={{ color: "#ccc" }}>OEH's SMS features — including load-posting notifications, match alerts, verification reminders, and transactional account messages — are delivered over a 10DLC-registered A2P messaging campaign in compliance with CTIA guidelines and applicable carrier requirements. You may receive messages only after explicit opt-in. Standard messaging and data rates may apply. Reply <strong>STOP</strong> to unsubscribe or <strong>HELP</strong> for assistance at any time. OEH does not share your phone number or SMS opt-in with third parties for marketing purposes. Consent to receive SMS is not a condition of using the Platform or purchasing a subscription.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>34. In-App Purchase & Subscription Management Policy</h2>
          <p style={{ color: "#ccc" }}>Subscriptions to OEH Member, Pro, Fleet, P/EVO Member, P/EVO Pro, and related tiers are sold, managed, and billed exclusively through our website at <a href="https://oversize-escort-hub.com" style={{ color: '#f90' }}>oversize-escort-hub.com</a> using Stripe. <strong>Subscriptions are not sold through the Apple App Store or Google Play in-app purchase systems.</strong> The OEH mobile apps (iOS and Android) are free tools that let active subscribers sign in and use features they have already purchased on the web. To upgrade, downgrade, change payment methods, update billing information, or cancel a subscription, visit your account billing page on oversize-escort-hub.com. Refunds, proration, and billing disputes are handled under Section 4 (Accounts & Subscriptions) of these Terms and are not subject to Apple or Google's refund policies.</p>
        </section>
        <section style={{ marginBottom: 32 }}>
          <h2 style={{ color: "#fff", fontSize: 18, marginBottom: 12 }}>35. Contact</h2>
