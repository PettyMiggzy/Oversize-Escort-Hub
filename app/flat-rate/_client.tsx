    ...
    return (
      <>
        ...
        borderRadius: '4px',
                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                        >
                                                                                                                                                                                                                                                                                                                                                                                                                                    <p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                  <strong>Route:</strong> {load.pu_city}, {load.pu_state} →{" "}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                {load.dl_city}, {load.dl_state}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      <strong>Escort Type:</strong> {load.escort_type}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <strong>Rate:</strong> ${(load.rate ?? load.per_mile_rate) != null ? Number(load.rate ?? load.per_mile_rate).toLocaleString() : 'TBD'}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        </p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    <p>
