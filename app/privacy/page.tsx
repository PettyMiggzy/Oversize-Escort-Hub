  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ccc", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "56px 24px 80px" }}>
        ...
        </div> <div style={{...s.section}}><h2 style={{...s.h2}}>26. Escort Availability Board</h2><p style={{...s.p}}>When escorts post on the Availability Board, their stated location, certifications, and availability window are stored and displayed to carriers. This information is public within the platform.</p></div><div style={{...s.section}}><h2 style={{...s.h2}}>27. SMS Load Posting</h2><p style={{...s.p}}>When you use SMS load posting, your phone number and message content are processed to create load listings. Message logs are retained for moderation purposes. You must have opted in to SMS services.</p></div><div style={{...s.section}}><h2 style={{...s.h2}}>28. BGC Badge</h2><p style={{...s.p}}>Background check data is processed by a third-party provider. OEH stores only the verification status (pass/fail) and badge issuance date. Raw background check results are not stored by OEH.</p></div><div style={{...s.section}}><h2 style={{...s.h2}}>29. Canadian Operations</h2><p style={{...s.p}}>Users in Canadian provinces are subject to applicable Canadian privacy laws including PIPEDA. Location and load data involving Canadian addresses is processed on the same infrastructure as US data.</p></div>
        <div style={{ ...s.section }}>
