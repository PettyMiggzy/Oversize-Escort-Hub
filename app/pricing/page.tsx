    ...
    return (
          <div className="section">
                ...
                <div className="price-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(240px,1fr))", gap: 16, marginBottom: 32 }}>
                  ...
                  {/* Fleet Manager Pro */}
                                <div style={{ maxWidth: 480, margin: "0 auto 32px", background: "var(--p2)", border: "2px solid #3b82f6", borderRadius: 12, padding: "28px 24px" }}>
                                                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                                                                  <span style={{ fontSize: 10, fontWeight: 700, background: "#1e3a5f", color: "#60a5fa", padding: "2px 8px", borderRadius: 99 }}>FLEET MANAGER</span>
                                                                                    <span style={{ fontSize: 10, fontWeight: 700, background: "#7c3aed", color: "#e9d5ff", padding: "2px 8px", borderRadius: 99 }}>COMING SOON</span>
                                                                                                    </div>
                                                                                                                    <div className="bb" style={{ fontSize: 22, marginBottom: 4 }}>FLEET MANAGER PRO</div>
                                                                                                                                    <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 16 }}>
                                                                                                                                                      <span style={{ fontSize: 32, fontWeight: 800, color: "#3b82f6" }}>$49.99</span>
                                                                                                                                                                        <span style={{ fontSize: 13, color: "var(--t2)" }}>/mo</span>
                                                                                                                                                                                        </div>
                                                                                                                                                                                                        <ul style={{ listStyle: "none", padding: 0, margin: "0 0 20px 0" }}>
                                                                                                                                                                                                                          {["Up to 5 escorts", "Fleet deadhead minimizer", "Roster management", "SMS dispatch", "Load board access", "Priority matching"].map((f) => (
                                                                                                                                                                                                                                              <li key={f} style={{ fontSize: 13, color: "var(--t1)", display: "flex", gap: 8, alignItems: "flex-start", marginBottom: 6 }}>
                                                                                                                                                                                                                                                                    <span style={{ color: "#3b82f6" }}>+</span>{f}
                                                                                                                                                                                                                                                                                        </li>
                                                                                                                                                                                                                                                                                                          ))}
                                                                                                                                                                                                                                                                                                                          </ul>
                                                                                                                                                                                                                                                                                                                                          <button disabled style={{ width: "100%", background: "#1e3a5f", color: "#60a5fa", border: "none", borderRadius: 6, padding: "10px 0", fontWeight: 700, fontSize: 14, cursor: "not-allowed", opacity: 0.7 }}>Coming Soon</button>
                                                                                                                                                                                                                                                                                                                                                        </div>
            {/* BGC Badge */}
